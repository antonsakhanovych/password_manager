...
namespace fileactions
{
    ...
    void get_all_passwords(std::filesystem::path const &path, std::string const &master_password, std::vector<std::unique_ptr<pass::Password>> &all_passwords);
    void search_pass(std::vector<std::unique_ptr<pass::Password>> &all_passwords);
    void sort_pass(std::vector<std::unique_ptr<pass::Password>> &all_passwords);
